...
/**
 *
 * @author mariannanicolosi
 */
public class MarriedTwo {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        String PATH = File.separator + "Users" + File.separator + "mariannanicolosi"  + File.separator + 
                             "Desktop"+ File.separator + "Lavoro"+File.separator+"CorsoWebReasoning"+File.separator+
                             "Lezioni201718"+File.separator+"EsempiLezione8"+File.separator;                   
        String inputFileName= "MarriedWJena2.rdf";
